        ...
        <div id="bgtext" className={` relative`}>
            ...
            <div className="wrapper pt-40 pb-[100vh] flex flex-col gap-8">
                ...
                <div className="flex pointer-events-none z-50 gap-8">
                    <p className="flex-1 text-justify">Our platform is distinguished by an on-prem approach that guarantees full control over data:
                        <br></br> <br></br>
